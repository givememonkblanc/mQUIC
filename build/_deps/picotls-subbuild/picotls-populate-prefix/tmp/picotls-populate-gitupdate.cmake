...
execute_process(
  COMMAND "/opt/homebrew/bin/git" --git-dir=.git show-ref "f350eab60742138ac62b42ee444adf04c7898b0d"
  WORKING_DIRECTORY "/Users/dohyeonlim/mQUIC-1/build/_deps/picotls-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  if(tag_sha STREQUAL head_sha)
    message(VERBOSE "Already at requested tag: f350eab60742138ac62b42ee444adf04c7898b0d")
    return()
  endif()
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"f350eab60742138ac62b42ee444adf04c7898b0d\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/dohyeonlim/mQUIC-1/build/_deps/picotls-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/dohyeonlim/mQUIC-1/build/_deps/picotls-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
