...
execute_process(
  COMMAND "/opt/homebrew/bin/git" --git-dir=.git show-ref "5a4461d8a3948d9d26bf861e7d90cb80d8093515"
  WORKING_DIRECTORY "/Users/dohyeonlim/mQUIC/build/_deps/picotls-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  if(tag_sha STREQUAL head_sha)
    message(VERBOSE "Already at requested tag: 5a4461d8a3948d9d26bf861e7d90cb80d8093515")
    return()
  endif()
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/dohyeonlim/mQUIC/build/_deps/picotls-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/dohyeonlim/mQUIC/build/_deps/picotls-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
